negative_one = "Zeke is a very positive person and encourages those around him,
...
negative_two = "Thus far, there have been two concerns over Yvonne's performance,
...
positive_one = "Xavier is a huge asset to SciMed and is a pleasure to work with.  He
...
positive_two = "Wanda has been an incredibly consistent and effective developer.  Clients
